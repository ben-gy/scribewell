/**
 * Event log — categorized live trail (adapted from Dropwell).
 *
 * A singleton log the app emits into. The drawer subscribes and renders
 * events with timestamps, category tags, levels, and structured metadata.
 */

export type EventCategory = 'system' | 'ui' | 'audio' | 'model' | 'asr';
...
const ALL_CATS: EventCategory[] = ['system', 'ui', 'audio', 'model', 'asr'];
